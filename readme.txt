...
1. You can then either add Make Tabbloid to your sidebar as a widget or by placing `<?php do_makeTabbloid('linkName','fileName', showThumbnail); ?>` in your template
...
If you used version 0.9.2 or earlier and used the function makeTabbloid('linkName','fileName', showThumbnail) in your template you will need to change this to do_makeTabbloid('linkName','fileName', showThumbnail).  
