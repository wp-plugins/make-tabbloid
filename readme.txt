...
**THE END** HP recently removed 3rd party access to their Tabbloid service which breaks this plugin. An entirely open source alternative which can be self-hosted, called 'Make PDF Newspaper' has been developed and can be [downloaded here](http://wordpress.org/extend/plugins/make-pdf-newspaper/).
...
This plugin in now obsolete and users should updrade to [Make PDF Newspaper](http://wordpress.org/extend/plugins/make-pdf-newspaper/)

== Changelog ==
**1.0.0** - The End. HP have removed API access. Please upgrade to updrade [Make PDF Newspaper](http://wordpress.org/extend/plugins/make-pdf-newspaper/)
